<template>
  <div class="bg-white border-b flex flex-col w-full p-5">
    <div v-for="parent in details" :key="parent.id">
      <div
        class="flex flex-col ml-2 bg-white p-2 rounded border-l-4 mb-2 w-100"
      ...
      >
        <template>
          ...
          <div v-if="parent.toggledItems" class="w-100">
            <div
              v-for="parentSpent in parent.spents"
              class="text-xs bg-gray-400 text-white font-bold ml-5 flex flex-col justify-between items-start gap-5 w-100"
            >
