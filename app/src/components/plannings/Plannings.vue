<template>
  <div class="main">
    ...
    <main>
      ...
      />
      <BankCard
        v-if="popupBankCardVisible"
        @isVisible="handleCC()"
        @save="saveCC"
      />
      <CreateInstallments
        v-if="popupInstallmentsVisible"
...
const { togglePopup: toggleBankCard, toggled: popupBankCardVisible } =
  usePopup("bankCard");
const { togglePopup: toggleItemType, toggled: popupItemTypeVisible } =
  usePopup("itemType");
const { togglePopup: toggleInstallments, toggled: popupInstallmentsVisible } =
